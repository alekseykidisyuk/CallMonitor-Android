...
val ciVersionCode = providers.gradleProperty("versionCode").map { it.toIntOrNull() }.orElse(10630)
val ciVersionName = providers.gradleProperty("versionName").orElse("1.5.3")
