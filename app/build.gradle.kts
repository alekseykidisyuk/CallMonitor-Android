...
val ciVersionCode = providers.gradleProperty("versionCode").map { it.toIntOrNull() }.orElse(20102)
val ciVersionName = providers.gradleProperty("versionName").orElse("2.1.2")
