...
val ciVersionCode = providers.gradleProperty("versionCode").map { it.toIntOrNull() }.orElse(10560)
val ciVersionName = providers.gradleProperty("versionName").orElse("1.4.9")
