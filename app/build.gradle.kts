...
val ciVersionCode = providers.gradleProperty("versionCode").map { it.toIntOrNull() }.orElse(20200)
val ciVersionName = providers.gradleProperty("versionName").orElse("2.2.0")
