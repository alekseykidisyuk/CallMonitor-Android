...
val ciVersionCode = providers.gradleProperty("versionCode").map { it.toIntOrNull() }.orElse(10550)
val ciVersionName = providers.gradleProperty("versionName").orElse("1.4.8")
