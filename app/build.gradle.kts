...
val ciVersionCode = providers.gradleProperty("versionCode").map { it.toIntOrNull() }.orElse(10571)
val ciVersionName = providers.gradleProperty("versionName").orElse("1.5.0")
