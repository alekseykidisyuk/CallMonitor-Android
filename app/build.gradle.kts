...
val ciVersionCode = providers.gradleProperty("versionCode").map { it.toIntOrNull() }.orElse(10540)
val ciVersionName = providers.gradleProperty("versionName").orElse("1.4.7")
