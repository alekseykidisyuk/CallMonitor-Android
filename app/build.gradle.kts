...
val ciVersionCode = providers.gradleProperty("versionCode").map { it.toIntOrNull() }.orElse(20100)
val ciVersionName = providers.gradleProperty("versionName").orElse("2.1.0")
